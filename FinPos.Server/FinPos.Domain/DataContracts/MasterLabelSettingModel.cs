...
{
    [DataContract]
    public class MasterLabelSettingModel
    {
        public MasterLabelSettingModel() { }
        public MasterLabelSettingModel(int? id, int labelSettingCode, bool printItemCode, bool printItemDetail, string printUnitMeasure, bool printItemPrice, bool printBarCode, string barCodeHeight, string labelSheet, string totalNoOfPrints, string startRow, string startColumn)
        {
            Id = id;
